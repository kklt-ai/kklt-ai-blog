...
export function FeatureSection({ copy }: FeatureSectionProps) {
  ...
  return (
    <section id="works" className="bg-[var(--color-bg)] py-10 pb-[60px] max-[640px]:py-[30px] max-[640px]:pb-[50px]">
      <h2
        className="m-0 mb-[35px] text-center text-[34px] font-medium tracking-[0.4px] text-[var(--color-ink)] max-[640px]:mx-5 max-[640px]:text-[24px]"
