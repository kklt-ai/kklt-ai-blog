...
import { EditorPanel } from "@/md-image/components/EditorPanel";
import { PreviewPanel } from "@/md-image/components/PreviewPanel";
import { SettingsPanel } from "@/md-image/components/SettingsPanel";
import { clampDimensions, resolvePageDimensions } from "@/md-image/lib/dimensions";
import {
  downloadNodesAsZip,
  downloadNodeAsPng,
  exportPageFilename,
...
} from "@/md-image/lib/localImages";
import { parseMarkdown } from "@/md-image/lib/markdown";
import { paginateSegments } from "@/md-image/lib/pagination";
import { DEFAULT_DIMENSIONS, SAMPLE_MARKDOWN } from "@/md-image/lib/sample";
import { defaultTheme, getThemeById } from "@/md-image/lib/themes";
import {
  clampFontSize,
  defaultTypography,
  isFontId,
...
import type { Dimensions, WatermarkSettings } from "@/md-image/lib/types";
import {
  DEFAULT_WATERMARK_SETTINGS,
  normalizeWatermarkSettings,
} from "@/md-image/lib/watermark";

const STORAGE_KEY = "xhs-md-image-tool";
const appShellClassName =
  "grid min-h-screen grid-cols-[minmax(280px,0.95fr)_minmax(360px,1.35fr)_minmax(300px,0.95fr)] gap-[18px] p-[18px] max-[1080px]:grid-cols-1 max-sm:gap-3 max-sm:p-2.5";
...
export function MarkdownImageApp() {
